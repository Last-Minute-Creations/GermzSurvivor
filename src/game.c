	...
	switch(s_eHudState) {
		...
		case HUD_STATE_DRAW_EXP_POINTS:
			...
			blitRect(
				...
				HUD_SCORE_NUMBER_SIZE_X, HUD_SCORE_NUMBER_SIZE_Y, COLOR_HUD_BG
			);
			fontDrawTextBitMap(
		...
		case HUD_STATE_DRAW_LEVEL_NUM: {
			...
			blitRect(
				...
				HUD_LEVEL_NUMBER_SIZE_X, HUD_LEVEL_NUMBER_SIZE_Y, COLOR_HUD_BG
			);
			fontDrawTextBitMap(
