...
set(AUDIO_MIXER_HQ_MODE OFF CACHE BOOL "Enable HQ mode (full 8-bit quality)")
...
set(AUDIO_MIXER_INTERRUPT_COUNTER OFF CACHE BOOL "Enables interrupt counter, allows access via MixerResetCounter() and MixerGetCounter().")
set(AUDIO_MIXER_ENABLE_CALLBACK OFF CACHE BOOL "Enables callbacks for sample playback end.")
set(AUDIO_MIXER_ENABLE_PLUGINS OFF CACHE BOOL "Enables real-time effect plugins.")
set(AUDIO_MIXER_ENABLE_RETURN_VECTOR OFF CACHE BOOL "Enable user-defined function executed at the end of the mixer interrupt.")
...
message(STATUS "[MIX] AUDIO_MIXER_HQ_MODE: '${AUDIO_MIXER_HQ_MODE}'")
...
message(STATUS "[MIX] AUDIO_MIXER_INTERRUPT_COUNTER: '${AUDIO_MIXER_INTERRUPT_COUNTER}'")
message(STATUS "[MIX] AUDIO_MIXER_ENABLE_CALLBACK: '${AUDIO_MIXER_ENABLE_CALLBACK}'")
message(STATUS "[MIX] AUDIO_MIXER_ENABLE_PLUGINS: '${AUDIO_MIXER_ENABLE_PLUGINS}'")
message(STATUS "[MIX] AUDIO_MIXER_ENABLE_RETURN_VECTOR: '${AUDIO_MIXER_ENABLE_RETURN_VECTOR}'")
...
set(CFG_MIXER_HQ_MODE 0)
if(AUDIO_MIXER_HQ_MODE)
	set(CFG_MIXER_HQ_MODE 1)
endif()
...
set(CFG_MIXER_COUNTER 0)
if(AUDIO_MIXER_INTERRUPT_COUNTER)
	set(CFG_MIXER_COUNTER 1)
endif()

set(CFG_MIXER_ENABLE_CALLBACK 0)
if(AUDIO_MIXER_ENABLE_CALLBACK)
	set(CFG_MIXER_ENABLE_CALLBACK 1)
endif()

set(CFG_MIXER_ENABLE_PLUGINS 0)
if(AUDIO_MIXER_ENABLE_PLUGINS)
	set(CFG_MIXER_ENABLE_PLUGINS 1)
endif()

set(CFG_MIXER_ENABLE_RETURN_VECTOR 0)
if(AUDIO_MIXER_ENABLE_RETURN_VECTOR)
	set(CFG_MIXER_ENABLE_RETURN_VECTOR 1)
endif()
...
configure_file(src/mixer_config.h.in mixer_config.h)
